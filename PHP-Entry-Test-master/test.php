...
<h2> By: Marie Kelling - 2/22/2020</h2>
<br />
<?php
...
echo '<input id="text" type="text" value="'.$dateTime.'" disabled="true">';
?>
...
<?php 
    ...
    //$size = count($programmingLanguages); 
?>
<?php foreach($programmingLanguages as $lang){ ?>
    <option value="<?php echo strtolower($lang); ?>"><?php echo $lang; ?></option>
<?php } ?> 	
</select>
